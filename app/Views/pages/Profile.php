<div class="container align-middle">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <img src="<?= base_url() ?>/imagens/<?= $user['avatar'] ?>" alt="<?= $user['first_name'] ?>"
                class="img-fluid">
            <?php else : ?>
    ...
    <h3 class="py-3">Publicações já feitas:</h3>
        ...
        <form action="<?php if (isset($_REQUEST['page'])) echo "?page{$_REQUEST['page']}"; ?>" method="get">
            ...
            <div class="form-group mt-3">
                <button type="submit" class="btn btn-success"
                    style="background-color: rgb(14, 165, 211); color:#fff">Ordenar</button>
            </div>
        </form>
    </div>
    ...
    <?php else : ?>
    <div class="alert alert-warning">
        Não há nenhum conteúdo cadastrado.
    </div>
    <?php endif; ?>
            ...
            <ul class="pagination">
                ...
                <li class="page-item">
                    <a class="page-link" href="?page=<?php echo "{$anterior}{$reverse}{$orderby}"; ?>"
                        ...
                        <span class="sr-only" style="background-color: rgb(14, 165, 211); color:#fff">Anterior</span>
                    </a>
                </li>
                <?php endif; ?>
                ...
                <li class="page-item active"><a class="page-link"
                        style="background-color: rgb(14, 165, 211); color:#fff"
                        href="?page=<?php echo "{$i}{$reverse}{$orderby}"; ?>"><?= $i ?></a></li>
                <?php else : ?>
                <li class="page-item"><a class="page-link" style="background-color: rgb(14, 165, 211); color:#fff"
                        href="?page=<?php echo "{$i}{$reverse}{$orderby}"; ?>"><?= $i ?></a></li>
                <?php endif; ?>
                ...
                <li class="page-item">
                    <a class="page-link" href="?page=<?php echo "{$proximo}{$reverse}{$orderby}"; ?>"
                        ...
                        <span class="sr-only" style="background-color: rgb(14, 165, 211); color:#fff">Próximo</span>
                    </a>
                </li>
                <?php endif; ?>
            </ul>
